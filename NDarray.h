...
public:
    ...
    // ---------------------------------------------------------
    // Week 8: Element-wise Operations
    // ---------------------------------------------------------
    ...
    NDarray<T> operator+(const NDarray<T>& other) const
    {
        ...
        {
            throw std::invalid_argument("Shapes do not match for element-wise addition.");
        }
    ...
    NDarray<T> operator-(const NDarray<T>& other) const
    {
        if (shape_ != other.shape_)
        {
            throw std::invalid_argument("Shapes do not match for element-wise subtraction.");
        }
    ...
    NDarray<T> operator/(const NDarray<T>& other) const
    {
        if (shape_ != other.shape_)
        {
            throw std::invalid_argument("Shapes do not match for element-wise division.");
        }
